...
function Submitted({event}: { event: TraceEvent }) {
    return <div>
        ...
        <p className="bp3-text-large bp3-text-muted text-xl">If this is not you, please see the {location.name.toLowerCase().includes("library") ? " librarian" : " proctor on duty"} on duty</p>
    </div>
}
